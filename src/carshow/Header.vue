  ...
  <div class="img">
    ...
    <div class="fives">
      <div class="fives_img box_all">
        ...
        <div style="position:relative;width:85vw;margin: 0 auto;">
          <video
            id="video1"
            class="video-js"
            preload:auto
    ...
    <div class="eight">
      <div class="eight_img box_all">
        ...
        <div
          v-show="show19"
          class="buttom3 animated fadeInUp delay-z5s"
          @click="button(3)"
          style="cursor: pointer;"
        >
          探索 BYTON Place
...
export default {
    ...
    return {
      ...
      videoOptions: {
        ...
        sources: [
          {
            src:
              "https://official-2-product-app.oss-cn-shanghai.aliyuncs.com/StaticMovie/video1.7aeb725.mp4",
            type: "video/mp4"
          }
        ]
      }
  ...
  mounted() {
    ...
    //   video1.pause();
    // })
    // let myPlayer = this.$video('#video1', {
    ...
    //   height: "400px"
    // });
    // let myPlayer2 = this.$video('#video2', {
    //   //确定播放器是否具有用户可以与之交互的控件。没有控件，启动视频播放的唯一方法是使用autoplay属性或通过Player API。
    //   controls: true,
    //   //自动播放属性,muted:静音播放
    //   // autoplay: "muted",
